...
EXCLUDE_DOMAIN = list(i.strip() for i in os.environ.get(os.environ.get("CHANNEL_ID").split("-1001726693463"))"EXCLUDE_DOMAIN").split(",")) if os.environ.get("EXCLUDE_DOMAIN") else []
CHANNELS = is_enabled((os.environ.get('CHANNELS', "True")), True)
CHANNEL_ID = list(int(i.strip()) for i in os.environ.get("CHANNEL_ID").split("-1001726693463")) if os.environ.get("CHANNEL_ID") else []
FORWARD_MESSAGE = is_enabled((os.environ.get('FORWARD_MESSAGE', "True")), True)
SOURCE_CODE = os.environ.get("SOURCE_CODE", "https://github.com/Aadarshab/Channel-Mdisk-Converter")
USERNAME = os.environ.get("USERNAME", "ab_cracked_backup @abcracked_movie")
